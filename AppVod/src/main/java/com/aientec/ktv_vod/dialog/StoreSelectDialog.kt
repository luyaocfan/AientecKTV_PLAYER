...
import com.aientec.ktv_vod.databinding.DialogConfigurationBinding
import com.aientec.ktv_vod.databinding.ItemStoreBinding
import com.aientec.ktv_vod.viewmodel.SystemViewModel
import com.aientec.structure.Store

class StoreSelectDialog : DialogFragment() {
    ...
    private inner class InfoViewHolder(private val mBinding: ItemStoreBinding) :
    ...
    private inner class InfoAdapter : RecyclerView.Adapter<InfoViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): InfoViewHolder =
            InfoViewHolder(ItemStoreBinding.inflate(layoutInflater, parent, false))
